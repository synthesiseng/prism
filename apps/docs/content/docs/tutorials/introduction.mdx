...
Rather than providing a component framework, UI toolkit, state manager, or render model, Prism manages the coordination required to make native HTML-in-Canvas surfaces practical inside real-time canvas applications.
...
Your application remains the owner of data, templates, interaction state, and render decisions. Prism handles the surface plumbing:
